    ...
    $.ajax({
        ...
        success: (response) => {
            ...
            if(changelog.length === 0 && changelog_page == 1){
                html = empty_html("Nema izmjena"); // Just using the existing function, to match the style
            }
        ...
        success: (response) => {
          console.log(response);
            ...
            if(resLen===7){
                ...
                prosecnaCena = "<th colspan='1'>Prosečna cijena</th>";
            ...
            if(resLen===13){
                ...
                prosecnaCena = "<th colspan='2'>Prosečna cijena</th>";
            ...
            if(len>0){
                ...
                for(let i=0;i<objKeys.length;i++){
                    ...
                    if(objKeys[i]==="price_per_night"){
                        price_per_night = "<th>Cijena noćenja</th>";
                    }

                    if(objKeys[i]==="total_price"){
                        total_price = "<th>Ukupna cijena</th>";
                    }
