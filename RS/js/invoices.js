...
$("body").on("click", "#invoices_list .switch_button", function(){ // Show dialog and delete
  ...
  $.ajax({
    ...
    success: function(rezultat){
      ...
      add_change(`Izmenjen račun ${invoices_map[id].mark}`, sve.data.id); // Add changelog
    },
...
function invoice_html(loc, invoice, row_number) {
  ...
  var invoice_edit = `<div class='list_action'><img class='list_action_icon edit' title='Izmeni' id='invoice_edit_${id}'> </div>`;
