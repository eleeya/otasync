                          ...
                          $("#articles").append(`
                            <div class='list_row article'>
                              ...
                              <div class='article_actions'>
                                <div class='list_action' onclick="show_edit_article_form('${article.id}')"><img class='list_action_icon edit' title='Izmjeni'> </div>
...
function edit_article() {
    ...
    $.ajax({
        ...
        success: function(rezultat){
          ...
          add_change(`Izmjenjen artikal ${description}`, sve.data.id);
          var tree = $("#categories").jstree(true);
          tree.deselect_all();
          tree.select_node(node.id);
