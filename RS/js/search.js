    ...
    $.ajax({
      ...
      success: function(rezultat){
        ...
        if(sve.reservations.length){
          $("#search_results").append("<div class='section_title'> Rezervacije </div>");
        }
        ...
        if(sve.guests.length){
          $("#search_results").append("<div class='section_title'> Gosti </div>");
        }
        ...
        if(sve.invoices.length){
          $("#search_results").append("<div class='section_title'> Računi </div>");
        }
...
function form_search_function(){
  ...
  $.ajax({
    ...
    success: function(rezultat){
      ...
      // Save data and append
      if(sve.guests.length){
        $("#form_search_results").append("<div class='section_title'> Gosti </div>");
      }
      else {
        $("#form_search_results").remove();
        return;
