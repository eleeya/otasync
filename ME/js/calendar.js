  ...
  $("#cal_dialog_confirm").click(function(){
    ...
    $.ajax({
      ...
      success: function(rezultat){
        ...
        add_change(`Izmjenjena rezervacija ${tetrisAjaxData.id}`, sve.data.id); // Add changelog
...
function send_room_status(status, room, room_number){
  $.ajax({
    ...
    success: function(rezultat){
      ...
      add_change("Izmjena sačuvana", sve.data.id);
...
var send_avail = function(dfrom, dto, values, rooms, variation_type)
{
  ...
  $.ajax({
    ...
    success: function(rezultat){
      ...
      add_change("Izmjenjena raspoživost", sve.data.id);
      click_to_hide()
      get_calendar();
    },
    error: function(xhr, textStatus, errorThrown){
...
var send_price = function(dfrom, dto, pid, values, rooms, variation_type)
{
  ...
  $.ajax({
    ...
    success: function(rezultat){
      ...
      add_change("Izmjenjene cene", sve.data.id);
      click_to_hide()
      get_calendar();
...
var send_restriction_compact = function(value, field, pid)
{
  ...
  $.ajax({
    ...
    success: function(rezultat){
      ...
      add_change("Izmjenjena restrikcije", sve.data.id);
