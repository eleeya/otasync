...
$("body").on("click", "#guests_list .switch_button", function(e){
  ...
  $.ajax({
    ...
    success: function(rezultat){
      ...
      add_change(`Izmenjen gost ${guests_map[id].name}`, sve.data.id); // Add changelog
    },
...
function guest_html(loc, guest, row_number) {
  ...
  var guest_edit = `<div class='list_action'><img class='list_action_icon edit' title='Izmeni'> </div>`;
