...
$("#new_group_reservation").click(function(){
  ...
  scroll_lock();
  // Clear values
  $("#form_group h1").text("Insert group reservation");
  $("#form_group_id").val("");
    ...
    <div class='flex_around form_group_guest' id='form_group_guest_${+(new Date())}'>
      ...
      <div class='vert_center'>
        ...
        <div class='flex_center'>
          <div class='list_action'><img class='list_action_icon edit' title='Additional data'> </div>
          <div class='list_action'><img class='list_action_icon delete' title='Delete'> </div>
        </div>
      </div>
    </div>`);
...
$("#form_group_confirm").click(function(){
  ...
  $.ajax({
    ...
    success: function(rezultat){
      ...
      if(id == "")
        add_change(`Added new reservation`, sve.data.id); // Add changelog
      else
...
// Getting available rooms and prices
        ...
        $("#form_group_rooms").append(
          `<div class='room' id='form_group_room_${room.id}'>
            <div class='form_group_room_room'>
              <div> ${room.name} </div>
              <div>
                Available: <span id='form_group_avail_${room.id}'>${room.avail}</span>
              </div>
            </div>
  ...
  $("#form_group_guests").append(`
    <div class='flex_around form_group_guest' id='form_group_guest_${+(new Date())}'>
      ...
      <div class='vert_center'>
        <div> &nbsp; </div>
        <div class='flex_center'>
          <div class='list_action'><img class='list_action_icon edit' title='Additional info'> </div>
          <div class='list_action'><img class='list_action_icon delete' title='Delete'> </div>
        </div>
      </div>
    </div>`);
...
// Updates prices on input changes
