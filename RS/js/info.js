...
$(document).ready(function(){
  ...
  $("body").on("change", "#res_info_guest_status", function(){
    ...
    $.ajax({
      ...
      success: function(rezultat){
        ...
        add_change(`Izmena sačuvana`, sve.data.id); // Add changelog
        get_calendar();
      },
  ...
  $("body").on("click", "#res_info_noshow, #res_info_invalidcc", function(){
    click_to_hide();
    add_change_settings("Izmena sačuvana");
  });
});
...
function open_res_info(res){
  ...
  {
    var status_html = `<div class='res_info_modified'> Izmenjena </div>`;
  ...
  $("body").append(`
    <div class='info' id='res_info'>
        ...
        <div class='res_info_section'>
          ...
          <div class='flex_start'>
            ...
            <div class='res_info_item'>
              <div class='res_info_tooltip_container'>
                <img class='res_info_icon' src='img/price_tag_white.svg'>
                <div class='res_info_tooltip bigger'> Cena po noćenju </div>
              </div>
        ...
        <div class='res_info_section'>
          ...
          <div class='res_info_item'>
            <div class='res_info_tooltip_container'>
              ...
              <div class='res_info_tooltip big'> Ukupna cena </div>
            </div>
      ...
      <div class='res_info_buttons'>
        ...
        <button class='confirm_button' id='res_info_edit'> Izmeni </button>
      </div>
    </div>
    `);
  ...
  $("body").append(`
    <div class='info' id='guest_info'>
      ...
      <div class='res_info_buttons'>
        ...
        <button class='confirm_button' data-value='${guest.id}' id='guest_info_edit'> Izmeni </button>
      </div>
    </div>
    `);
  var scroll = $("html").scrollTop() > $("body").scrollTop() ? $("html").scrollTop() : $("body").scrollTop();
