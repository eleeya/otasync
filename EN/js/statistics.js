...
const stat_month_names = [0, 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
const stat_bookwindow_names = [ '0-1 day', '2-3 days', '4-7 days', '8-14 days', '15-30 days', '31-60 days', '61-90 days', '90+ days'];
...
$(document).ready(function(){
  ...
  $("#stat_bar_select, #stat_line_select, #stat_cmp_select").change(function(){
    ...
    var line_data = [];
    var labels = [];
    var bar_cmp_item_name = bar_item_name + " previous";
    var line_cmp_item_name = line_item_name + " previous";
    ...
    {
      bar_cmp_item_name = "Planned earnings";
      var bar_cmp_data = [];
  ...
  $("#stat2_line_select, #stat2_cmp_select").change(function(){
    ...
    {
      line_cmp_item_name = "Planned earnings";
      var line_cmp_data = [];
      var plan = properties_map[main_lcode].planned_earnings;
      for(var i=0;i<cmp_stats.months.length;i++)
      {
...
// Getting info of guest to display in tooltip
