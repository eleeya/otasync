...
function guest_html(loc, guest, row_number) {
  ...
  var guest_edit = `<div class='list_action'><img class='list_action_icon edit' title='Edit'> </div>`;
  var guest_reservation = `<div class='list_action'><img class='list_action_icon reservation' title='Reservation'> </div>`;
  var guest_delete = `<div class='list_action'><img class='list_action_icon delete' title='Delete'> </div>`;
  var ret_val = `
    <div class="list_row guest" id='${loc}_${id}'>
      ...
      <div class='guest_info'>
        ...
        <div class='guest_arrivals'>${total_arrivals} arrivals, ${total_nights} nights</div>
      </div>
      ...
      <div class='guest_host_again'>
        ${create_switch_button("guest_host_" + id, host_again, "YES", "NO", true)}
      </div>
