...
$("#new_reservation").click(function(){
  ...
  scroll_lock();
  // Clear values
  $("#form_res h1").text("New reservation");
  $("#form_res_id").val("");
...
// Gets available rooms for single reservation
...
// Updates values of form on change
...
// Opens form from various triggers
function open_reservation_form(res) {
  ...
  scroll_lock();
  // Clear values
  $("#form_res h1").text("Update reservation");
...
function open_group_form(res) {
  ...
  scroll_lock();
  // Clear values
  $("#form_group h1").text("Update reservation");
